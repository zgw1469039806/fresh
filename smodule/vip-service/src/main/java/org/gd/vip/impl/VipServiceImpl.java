...
public class VipServiceImpl implements VipService {
    ...
    @Override
    public ResponseData<GdAddVipDTO> selectOne(Integer userid) {
        ResponseData<GdAddVipDTO> responseData=new ResponseData<>();
        responseData.setData(gdVipMapper.selevtOne(userid));
